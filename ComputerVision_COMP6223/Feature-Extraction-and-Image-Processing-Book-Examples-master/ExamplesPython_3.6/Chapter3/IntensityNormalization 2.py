...
from Modules.ImagePropertiesUtilities import imageMaxMin
from Modules.PlotUtilities import plotHistogram
from Modules.ImageOperatorsUtilities import computeHistogram
